    ...
    <div>
      ...
      <div className="flex items-center justify-center min-h-screen">
        ...
        <div className="p-6 border border-gray-300 font-['GmarketSans']">
          ...
          {/* 문의 내용 */}
          <div className="mb-8">
            <span className="text-gray-600 font-['GmarketSans'] font-thin">문의내용</span>
          ...
          <div className="flex justify-center space-x-4">
            <button className="px-12 py-2 text-black bg-white border border-gray-400 rounded-lg hover:bg-gray-200 font-['GmarketSans']">홈으로 가기</button>
            <button className="px-12 py-2 text-black bg-white border border-gray-400 rounded-lg hover:bg-gray-200 font-['GmarketSans']">예약 목록보기</button>
         </div>
        </div>
      </div>
      <Footer />
